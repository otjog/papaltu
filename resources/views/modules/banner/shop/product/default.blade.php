...
<div class="container fill_height">
    <div class="row fill_height">
        <div class="banner_product_image"><img class="float left img-fluid" src="{{ URL::asset('storage/img/banners/products/' . $banner->data->id) }}" alt=""></div>
        <div class="col-lg-5 offset-lg-4 fill_height">
            <div class="banner_content">
                ...
                @endif
                <div class="banner_price">{{$banner->data->prices[0]->value}}<i class="fas fa-ruble-sign"></i></div>
