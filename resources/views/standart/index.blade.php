...
<head>
    ...
    @else
        <title>Пальто для женщин. Зимние и демисезонные в интернет магазине Papaltu.ru.</title>
        <meta name="description" content="Интернет-магазин Papaltu. Каталог пальто для женщин. Продажа зимних пальто. Где купить пальто на зиму. Советы по выбору.">
        <meta name="keywords" content="Зимние пальто, купить пальто, продажа пальто, демисезонное пальто, куртки, ветровки для детей">
    @endif
