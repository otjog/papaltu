<div class="col-12 col-lg-7 offset-lg-1">
    ...
    <ul class="nav pb-2" id="tabs">
        <li class="nav-item">
            <span data-tabIndex="featured"  class="nav-link active">Рекомендуем Вам</span>
        </li>
        <li class="nav-item">
            <span data-tabIndex="sale"      class="nav-link">Распродажа</span>
        </li>
        <li class="nav-item">
            <span data-tabIndex="rated"     class="nav-link">Популярные</span>
        </li>
    </ul>

    <div id="tab-data">
        {{-- Featured Products Tab --}}
        <div class="tab-data data-featured">
                        ...
                        @foreach( $products_row as $key => $product )
                            ...
                            <!--span class="bg-light small px-1 py-1 w-50 rounded-bottom-right">Артикул: {{$product->scu or ''}}</span-->
                                ...
                                <!--Name-->
                                    ...
                                    <!--div class="product-action w-100 d-none text-center border-top pt-2 mt-2">
                                        <a href="{{ route( 'products.show', $product->id ) }}">
                                            Выбрать размер
                                        </a>
                                    </div-->
