                ...
                //todo расчет суммы корзины и параметров посылки расчитывать в моделях, а не во views
                    ...
                    @foreach( $basket->products as $product )
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            ...
                            <span class="ml-2">{{ $product->prices[0]->value * $product->quantity }}</span>
                    ...
                    <li class="list-group-item d-flex justify-content-between bg-light">
                        <span>Сумма:</span>
                        <strong>{{ $basket->total }} <span class="small"><i class="fas fa-ruble-sign"></i></span></strong>
                    </li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="delivery-offers" class="order-4 my-4" data-component="shop|order">
                            ...
                            @include('modules.delivery.reload.offers')
