@if( isset($basket->products) )
    ...
    {{-- MODALS --}}
    @include('modules.modals.forms.change-city')
    {{--   END  --}}

    <div class="col-12 col-lg-9">
        <h4 class="mb-3">Корзина</h4>
        <form method="POST" action="{{ route( 'baskets.update', csrf_token() ) }}" role="form" accept-charset="UTF-8" >
            ...
            <div id="delivery-best-offer" data-component="shop|basket">
                @include('modules.delivery.reload.best-offer')
            </div>
    ...
    <div class="col-12 col-lg-3 border-left rounded ">
        ...
        <div class="row px-2">
            <div class="col-10 offset-2 mb-3">Сумма товаров: {{ $basket->total }}<span class="small"><i class="fas fa-ruble-sign"></i></span></div>
            @if( $basket->total > 0)
