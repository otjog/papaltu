    ...
    <div class="row">
        ...
        <div class="col-lg-2 offset-lg-4">
            <div class="footer_column">
                ...
                @include('modules.menu.shop', ['menu_type' => 'list'])
        ...
        <div class="col-lg-2 offset-lg-1">
            <div class="footer_column">
                ...
                @include('modules.menu.page', ['menu_type' => 'list', 'menu_name' => 'info'])

                {{-- @include('modules.menu.page', ['menu_type' => 'list', 'menu_name' => 'about_us']) --}}
